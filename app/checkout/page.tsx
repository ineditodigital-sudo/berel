      ...
      <div className="checkout-layout">
        <section>
          ...
          <form onSubmit={submit}>
            ...
            {/* `autoComplete` deja que el teléfono rellene estos datos de una vez. */}
            <fieldset><legend>Datos de contacto</legend><div className="form-grid"><label>Nombre completo<input name="name" autoComplete="name" required /></label><label>Teléfono<input name="phone" type="tel" autoComplete="tel" inputMode="tel" required /></label><label className="wide">Correo electrónico<input name="email" type="email" autoComplete="email" inputMode="email" required /></label></div></fieldset>
            {fulfillment === "delivery" ? (
              <fieldset><legend><MapPin /> Dirección en Aguascalientes</legend><div className="form-grid"><label className="wide">Calle y número<input name="street" autoComplete="street-address" required /></label><label>Colonia<input name="neighborhood" autoComplete="address-level3" required /></label><label>Código postal<input name="postalCode" autoComplete="postal-code" inputMode="numeric" required /></label><label className="wide">Referencias<textarea name="references" /></label></div></fieldset>
            ) : (
